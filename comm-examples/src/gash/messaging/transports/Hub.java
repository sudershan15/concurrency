...
public class Hub implements MessageTransport {

	private int msgID;
	private Transport hub;
	...
	public class Transport extends Thread {
		private List<Node> spokes;
		private List<Message> inbox;

		public Transport() {
			inbox = Collections.synchronizedList(new ArrayList<Message>());
			spokes = Collections.synchronizedList(new ArrayList<Node>());
		}
		...
		public Node[] getNodes() {
			Node[] r = new Node[spokes.size()];
			return (Node[]) spokes.toArray(r);
		}
	 ...
	 * 
	 */
	public static class SpokeNode extends Node {
